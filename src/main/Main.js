...
function createWindow() {
  ...
  mainWindow.loadFile(path.join(__dirname, '../renderer/pages/dashboard.html'));   // Start page
}
...
ipcMain.on('go-to-create_tournament.html', () => { //dashboard to create tournament >>>> next
  mainWindow.loadFile(path.join(__dirname, '../renderer/pages/create_tournament.html'));
});

ipcMain.on('dashboard.html', () => {
  mainWindow.loadFile(path.join(__dirname, '../renderer/pages/dashboard.html')); // tourament to dashboard >>>>>back
});

ipcMain.on('tournament-updates.html', () => {
  mainWindow.loadFile(path.join(__dirname, '../renderer/pages/tournament_updates.html')); // navigate to tournament updates
});

ipcMain.on('add_difender.hrml', () => {
  mainWindow.loadFile(path.join(__dirname, '../renderer/pages/add_difender.html'));
});
...
ipcMain.on('open-popup-batch1', () => {
  ...
  popupWindow.loadFile(path.join(__dirname, '../renderer/pages/add_difender.html'))
...
ipcMain.on('open-window', (event, data) => {
  ...
  newWindow.loadFile(path.join(__dirname, '../renderer/pages/out.html'));
...
ipcMain.on('open-add-staff-popup', (event, data) => {
  ...
  popupWindow.loadFile(path.join(__dirname, '../renderer/assets/Electron/Staff_Login/Add_Staff_Popup.html'))
...
ipcMain.on('open-tournament-dashboard', (event, name) => {
  ...
  tourneyWindow.loadFile(path.join(__dirname, '../renderer/pages/tournament_dashboard.html'), { query: { name: name } });
